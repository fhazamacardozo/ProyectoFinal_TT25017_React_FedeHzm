    ...
    return (
        <Container className="my-5">
            ...
            <Row className="justify-content-center mb-5">
                <Col xs={12} md={10} lg={8} className="text-center"> {/* xs=12 para ocupar todo el ancho en móviles */}
                ...
                <Col xs={12}> {/* xs=12 para que la tarjeta ocupe todo el ancho en móviles */}
                    <Card className="shadow-sm">
                        <Card.Body>
                            ...
                            {/* Usamos g-3 para un espaciado consistente y ajustamos los breakpoints de Col */}
                            <Row className="text-center d-flex align-items-stretch g-3">
                                <Col xs={12} sm={6} md={3}> {/* En móvil muy pequeño se apilan (12/12), en pequeño (sm) 2 por fila, en mediano (md) 4 por fila */}
                    ...
                    <Card className="shadow-sm">
                        <Card.Body>
                            ...
                            {/* <Card.Text>
                                ...
                                // REMOVED UL FROM HERE
                            </Card.Text> */}
                            {/* NEW: Place the introductory text in a separate <p> or <Card.Text> */}
                            <Card.Text>
                                Este proyecto fue desarrollado como parte de un curso/bootcamp de desarrollo web full-stack
                                para aplicar conocimientos sobre:
                            </Card.Text>
                            {/* Now, the <ul> is a sibling of <Card.Text> inside <Card.Body> */}
                            <ul>
                    ...
                    <Card className="shadow-sm border-warning">
                        <Card.Body>
                            ...
                            <Card.Text>
                                ...
                                <br/><br/>
                                <strong>Email:</strong> <code>admin@ecommerce.com</code><br/>
            ...
            <Row className="mt-4 justify-content-center g-3"> {/* g-3 para espacio entre botones en móvil */}
                <Col xs={12} sm={6} md={4} className="text-center"> {/* xs=12 para apilar botones en móviles muy pequeños */}
